...
export const GameHeader: React.FC<Props> = ({ user, stats, balance, phase, timeLeft }) => {
    ...
    return (
        <header className="
            h-[60px] md:h-[75px] lg:h-[85px]
            px-4 md:px-6 lg:px-8
            flex items-center justify-between 
            z-50 shrink-0 
            border-b border-white/5 
            bg-neo-bg/80 backdrop-blur-md
        ">
            ...
            <div className="flex items-center gap-3 md:gap-4">
                ...
                ">
                    <span className="font-display font-bold text-black text-lg md:text-2xl lg:text-3xl">R</span>
                </div>
                <div className="flex flex-col">
                    <span className="font-display font-bold text-lg md:text-xl lg:text-2xl tracking-widest text-white leading-none">ROYALE</span>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-3 md:gap-4">
                {phase === GamePhase.WAITING_FOR_BETS ? (
                    ...
                    ">
                        <span className="w-2 md:w-2.5 lg:w-3 h-2 md:h-2.5 lg:h-3 rounded-full bg-red-500 animate-ping"></span>
                        <span className="
                            text-red-400 
                            text-xs md:text-sm lg:text-base
            ...
            <div className="flex items-center gap-3 md:gap-4">
                ...
                ">
                    <div className="
                        ...
                        flex items-center justify-center 
                        font-bold text-sm md:text-base lg:text-lg text-white
                    ">
