    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed top-0 left-0 h-[100dvh] w-full md:w-[100vw] bg-neo-bg/70 backdrop-blur-lg z-[200] shadow-2xl border-r border-neo-gold/20 flex flex-col"
            >
                ...
                {/* Wheel Content */}
                <div className="flex-1 flex items-center justify-center p-0 md:p-4 relative overflow-hidden">
                    ...
                    <div className="relative w-full aspect-square max-h-[100dvh] md:max-h-[90vh] flex items-center justify-center">
